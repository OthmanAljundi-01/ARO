...
echo you can also refer to the following link for the latest release of OC : https://mirror.openshift.com/pub/openshift-v4/clients/ocp/latest/
...
/opt/openshift/bin/oc completion bash > oc_bash_completion
